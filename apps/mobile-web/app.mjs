...
root.addEventListener("click", (e) => {
  ...
  run(async () => {
    if (a === "inspect") {
      const report = await phone.inspect(
        rid || null,
        el.dataset.binding || null,
      );
      inspections.set(rid || el.dataset.binding, report);
    }
